    ...
    return (
      <div class="app">
        <header class="page-header">
          <div class="title">Викторина на Web Standards Days</div>
          <LoginStatus
            server={server}
            user={user}
        ...
        <a class="privacy" href="https://github.com/jakearchibald/big-web-quiz" target="_blank">Форк Большого Веб Квиза от Google</a>
        {server &&
